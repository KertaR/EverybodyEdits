package com.protobuf
{
   ...
   public final class CodedOutputStream
   {
      ...
      {
         writeRawByte(param1 & 0xFF);
         writeRawByte(param1 >> 8 & 0xFF);
         writeRawByte(param1 >> 16 & 0xFF);
         writeRawByte(param1 >> 24 & 0xFF);
      }
   }
}
