package
{
   ...
   public class Chat extends BlContainer
   {
      ...
      protected var microchatimage:Class = Chat_microchatimage;
      
      private var microchat:BlSprite = BlSprite.createFromBitmapData(new this.microchatimage().bitmapData);
      ...
      protected var teamdotsimage:Class = Chat_teamdotsimage;
      
      private var teamdot:BlSprite = new BlSprite(new this.teamdotsimage().bitmapData,0,0,16,16,6);
      ...
      public function drawNpcName(param1:BitmapData, param2:Number, param3:Number) : void
      {
         this.name.draw(param1,param2,param3);
      }
      
      public function drawNpcChat(param1:BitmapData, param2:Number, param3:Number, param4:Boolean = true) : void
      {
         var _loc5_:int = 0;
         if(!param4)
         {
            _loc5_ = 0;
            while(_loc5_ < this.chats.length)
            {
               this.addToQueue(this.chats[_loc5_],param1,param2,param3);
               _loc5_++;
            }
         }
         else
