package animations
{
   ...
   public class AnimationManager
   {
      ...
      public static function createRotationAnimation(param1:BitmapData, param2:int, param3:int) : BitmapData
      {
         ...
         var _loc4_:BitmapData = new BitmapData(param1.width * param2,param1.height,true,0);
         var _loc5_:int = 0;
         while(_loc5_ < param2)
         {
            _loc6_ = new Matrix();
            ...
            _loc6_.translate(param1.width / 2,param1.height / 2);
            _loc6_.translate(param1.width * _loc5_,0);
      ...
      public static function combine(param1:BitmapData, param2:BitmapData, param3:Point = null) : BitmapData
      {
         var _loc4_:BitmapData = new BitmapData(Math.max(param1.width,param2.width),Math.max(param1.height,param2.height),true,0);
         _loc4_.copyPixels(param1,param1.rect,new Point(),null,null,true);
         _loc4_.copyPixels(param2,param2.rect,param3 ? param3 : new Point(),null,null,true);
         return _loc4_;
      }
