package
{
   ...
   public class ImageUtils
   {
      ...
      public static function createNpcImageFromPayVaultId(param1:String) : BitmapData
      {
         var _loc2_:ItemNpc = ItemManager.getNpcByPayvaultId(param1);
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      private static function createImageFromBrickArray(param1:Vector.<ItemBrick>) : BitmapData
      {
         ...
         var _loc3_:BitmapData = new BitmapData(param1.length * 16 > _loc2_ ? _loc2_ : int(param1.length * 16),param1.length * 16 > _loc2_ ? (param1.length * 16 > _loc2_ * 2 ? (param1.length * 16 > _loc2_ * 3 ? 64 : 48) : 32) : 16,true,0);
         var _loc4_:int = 0;
         var _loc5_:int = -16;
         var _loc6_:int = 0;
