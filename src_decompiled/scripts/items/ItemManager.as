package items
{
   ...
   public class ItemManager
   {
      ...
      public static function init() : void
      {
         ...
         _loc8_.addBrick(createBrick(45,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,45,4285686091,["X","Crate","Metal","Box","Wood"]));
         _loc8_.addBrick(createBrick(46,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,46,4285426528,["Concrete","Grey","Gray","Stone","Slate","X"]));
         _loc8_.addBrick(createBrick(47,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,47,4287525711,["Wood","Tree","Wooden","House","Planks","Flooring","Parquet"]));
         _loc8_.addBrick(createBrick(48,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,48,4286533419,["X","Crate","Wooden","Box","Wood","Storage"]));
         _loc8_.addBrick(createBrick(49,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,49,4285887861,["Silver","Metal","Scales"]));
         brickPackages.push(_loc8_);
         var _loc9_:ItemBrickPackage = new ItemBrickPackage("secrets","Secret Bricks",["Hidden","Invisible"]);
         _loc9_.addBrick(createBrick(44,ItemLayer.FORGROUND,blocksBMD,"","completely black, makes minimap invisible",ItemTab.BLOCK,false,true,44,16777216,["Black","Pure","Old","Solid"]));
         _loc9_.addBrick(createBrick(50,ItemLayer.DECORATION,specialBlocksBMD,"","",ItemTab.BLOCK,false,true,139,0,["Appear"]));
         _loc9_.addBrick(createBrick(243,ItemLayer.DECORATION,specialBlocksBMD,"","",ItemTab.BLOCK,false,true,140,16777216,["Blank","Hidden"]));
         _loc9_.addBrick(createBrick(136,ItemLayer.DECORATION,specialBlocksBMD,"","",ItemTab.BLOCK,false,false,141,0,["Disappear"]));
         ...
         _loc10_.addBrick(createBrick(51,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,51,4294480537,["Red","Light red","Pink","Ruby"]));
         _loc10_.addBrick(createBrick(58,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,58,4294359700,["Orange","Light orange","Topaz"]));
         _loc10_.addBrick(createBrick(57,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,57,4294498956,["Yellow","Light yellow","Jasmine"]));
         _loc10_.addBrick(createBrick(56,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,56,4287822762,["Green","Light green","Emerald"]));
         _loc10_.addBrick(createBrick(55,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,55,4288011510,["Cyan","Light blue","Diamond"]));
         _loc10_.addBrick(createBrick(54,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,54,4286487030,["Blue","Sapphire"]));
         _loc10_.addBrick(createBrick(53,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,53,4289169910,["Purple","Violet","Amethyst"]));
         _loc10_.addBrick(createBrick(52,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,52,4293495798,["Pink","Magenta","Purple","Quartz"]));
         ...
         _loc18_.addBrick(createBrick(ItemId.WORLD_PORTAL_SPAWN,ItemLayer.DECORATION,decoBlocksBMD,"","a spawn point targetable by world portals",ItemTab.ACTION,true,false,354,0,["Spawn","Start","Beginning","Enter","World","Red"]));
         ...
         _loc18_.addBrick(createBrick(ItemId.GOD_BLOCK,ItemLayer.ABOVE,decoBlocksBMD,"","gives the player god mode privileges",ItemTab.ACTION,true,false,320,0,["God"]));
         _loc18_.addBrick(createBrick(ItemId.MAP_BLOCK,ItemLayer.ABOVE,decoBlocksBMD,"","allows the player to use the minimap when disabled",ItemTab.ACTION,true,false,355,0,["Map","Minimap"]));
         ...
         _loc19_.addBrick(createBrick(ItemId.CROWNGATE,ItemLayer.DECORATION,doorBlocksBMD,"","",ItemTab.ACTION,false,true,40,0,["Crown","Gate","Gold","Yellow","Lock"]));
         _loc19_.addBrick(createBrick(ItemId.CROWNDOOR,ItemLayer.DECORATION,doorBlocksBMD,"","",ItemTab.ACTION,false,true,41,0,["Crown","Door","Gold","Yellow","Lock"]));
         ...
         _loc19_.addBrick(createBrick(ItemId.SILVERCROWNGATE,ItemLayer.DECORATION,doorBlocksBMD,"","",ItemTab.ACTION,false,true,42,0,["Crown","Gate","Silver","Lock"]));
         _loc19_.addBrick(createBrick(ItemId.SILVERCROWNDOOR,ItemLayer.DECORATION,doorBlocksBMD,"","",ItemTab.ACTION,false,true,43,0,["Crown","Door","Silver","Lock"]));
         ...
         _loc28_.addBrick(createBrick(ItemId.SPIKE_SILVER_CENTER,ItemLayer.DECORATION,specialBlocksBMD,"","kills the player",ItemTab.ACTION,false,false,872,0,["Spikes","Floating","Centre","Center","Central","Mine","Hover"]));
         ...
         _loc28_.addBrick(createBrick(ItemId.SPIKE_BLACK_CENTER,ItemLayer.DECORATION,specialBlocksBMD,"","kills the player",ItemTab.ACTION,false,false,877,0,["Spikes","Floating","Centre","Center","Central","Mine","Hover","Silver","Light","White","Gray","Grey"]));
         ...
         _loc28_.addBrick(createBrick(ItemId.SPIKE_RED_CENTER,ItemLayer.DECORATION,specialBlocksBMD,"","kills the player",ItemTab.ACTION,false,false,882,0,["Spikes","Floating","Centre","Center","Central","Mine","Hover","Black","Dark","Gray","Grey"]));
         ...
         _loc28_.addBrick(createBrick(ItemId.SPIKE_GOLD_CENTER,ItemLayer.DECORATION,specialBlocksBMD,"","kills the player",ItemTab.ACTION,false,false,887,0,["Spikes","Floating","Centre","Center","Central","Mine","Hover","Yellow","Gold"]));
         ...
         _loc28_.addBrick(createBrick(ItemId.SPIKE_GREEN_CENTER,ItemLayer.DECORATION,specialBlocksBMD,"","kills the player",ItemTab.ACTION,false,false,892,0,["Spikes","Floating","Centre","Center","Central","Mine","Hover","Green"]));
         ...
         _loc28_.addBrick(createBrick(ItemId.SPIKE_BLUE_CENTER,ItemLayer.DECORATION,specialBlocksBMD,"","kills the player",ItemTab.ACTION,false,false,897,0,["Spikes","Floating","Centre","Center","Central","Mine","Hover","Blue"]));
         ...
         _loc42_.addBrick(createBrick(718,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,212,-1,["White","Light"]));
         _loc42_.addBrick(createBrick(513,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,513 - 500,-1,["Gray","Grey","Shadow"]));
         _loc42_.addBrick(createBrick(650,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,144,-1,["Black","Dark","Shadow"]));
         _loc42_.addBrick(createBrick(516,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,516 - 500,-1,["Red","Pink"]));
         _loc42_.addBrick(createBrick(649,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,143,-1,["Orange"]));
         _loc42_.addBrick(createBrick(517,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,517 - 500,-1,["Yellow","Lime"]));
         _loc42_.addBrick(createBrick(518,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,518 - 500,-1,["Green"]));
         _loc42_.addBrick(createBrick(519,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,519 - 500,-1,["Cyan","Teal","Turquoise","Blue"]));
         _loc42_.addBrick(createBrick(514,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,514 - 500,-1,["Blue"]));
         _loc42_.addBrick(createBrick(515,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,515 - 500,-1,["Purple","Magenta","Pink","Violet"]));
         brickPackages.push(_loc42_);
         var _loc43_:ItemBrickPackage = new ItemBrickPackage("dark","Solid Dark Backgrounds",["Solid"]);
         _loc43_.addBrick(createBrick(719,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,213,-1,["White","Light"]));
         _loc43_.addBrick(createBrick(520,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,520 - 500,-1,["Gray","Grey","Shadow"]));
         _loc43_.addBrick(createBrick(652,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,146,-1,["Black","Dark","Shadow"]));
         _loc43_.addBrick(createBrick(523,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,523 - 500,-1,["Red"]));
         _loc43_.addBrick(createBrick(651,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,145,-1,["Orange"]));
         _loc43_.addBrick(createBrick(524,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,524 - 500,-1,["Yellow","Lime"]));
         _loc43_.addBrick(createBrick(525,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,525 - 500,-1,["Green"]));
         _loc43_.addBrick(createBrick(526,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,526 - 500,-1,["Cyan","Teal","Turquoise","Blue"]));
         _loc43_.addBrick(createBrick(521,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,521 - 500,-1,["Blue"]));
         _loc43_.addBrick(createBrick(522,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,522 - 500,-1,["Purple","Magenta","Pink","Violet"]));
         brickPackages.push(_loc43_);
         var _loc44_:ItemBrickPackage = new ItemBrickPackage("normal","Solid backrounds",["Solid"]);
         _loc44_.addBrick(createBrick(717,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,211,-1,["White","Light"]));
         _loc44_.addBrick(createBrick(610,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,110,-1,["Gray","Grey","Shadow"]));
         _loc44_.addBrick(createBrick(654,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,148,-1,["Black","Dark","Shadow"]));
         _loc44_.addBrick(createBrick(613,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,113,-1,["Red"]));
         _loc44_.addBrick(createBrick(653,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,147,-1,["Orange"]));
         _loc44_.addBrick(createBrick(614,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,114,-1,["Yellow","Lime"]));
         _loc44_.addBrick(createBrick(615,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,115,-1,["Green"]));
         _loc44_.addBrick(createBrick(616,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,116,-1,["Cyan","Teal","Turquoise","Blue"]));
         _loc44_.addBrick(createBrick(611,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,111,-1,["Blue"]));
         _loc44_.addBrick(createBrick(612,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,112,-1,["Purple","Magenta","Pink","Violet"]));
         ...
         _loc45_.addBrick(createBrick(532,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,32,-1,["Pink","Red","Magenta"]));
         _loc45_.addBrick(createBrick(676,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,170,-1,["Orange"]));
         _loc45_.addBrick(createBrick(527,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,27,-1,["Yellow"]));
         _loc45_.addBrick(createBrick(529,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,29,-1,["Yellow","Green","Lime"]));
         _loc45_.addBrick(createBrick(528,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,28,-1,["Green"]));
         _loc45_.addBrick(createBrick(530,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,30,-1,["Cyan","Light Blue","Sky"]));
         _loc45_.addBrick(createBrick(531,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,31,-1,["Blue","Sky"]));
         _loc45_.addBrick(createBrick(677,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,171,-1,["Purple"]));
         ...
         _loc60_.addBrick(createBrick(ItemId.WAVE,ItemLayer.ABOVE,specialBlocksBMD,"","",ItemTab.DECORATIVE,false,false,234,0,["Waves","Animated"]));
         _loc60_.addBrick(createBrick(574,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,74,4285913831));
         _loc60_.addBrick(createBrick(575,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,75,4285913831,["Octopus","Squid"]));
         _loc60_.addBrick(createBrick(576,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,76,4285913831,["Fish"]));
         _loc60_.addBrick(createBrick(577,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,77,4285913831,["Seahorse"]));
         _loc60_.addBrick(createBrick(578,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,78,4285913831,["Seaweed","Plant","Algae"]));
         ...
         _loc65_.addBrick(createBrick(594,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,94,-1,["White","Tile","Bathroom"]));
         _loc65_.addBrick(createBrick(595,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,95,-1,["Brick","Tile","Bathroom"]));
         _loc65_.addBrick(createBrick(596,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,96,-1,["Diamond","Chisel","Tile","Bathroom"]));
         _loc65_.addBrick(createBrick(597,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,97,-1,["X","Cross","Chisel","Bathroom","Tile"]));
         _loc65_.addBrick(createBrick(598,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,98,-1,["Rough","Natural"]));
         ...
         _loc68_.addBrick(createBrick(172,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,146,-1,["White","Metal","Plate"]));
         _loc68_.addBrick(createBrick(173,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,147,-1,["Blue","Metal","Plate"]));
         _loc68_.addBrick(createBrick(174,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,148,-1,["Green","Metal","Plate"]));
         _loc68_.addBrick(createBrick(175,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,149,-1,["Red","Magenta","Metal","Plate","Pink"]));
         _loc68_.addBrick(createBrick(176,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,150,4294945604,["Sand","Mars","Orange"]));
         _loc68_.addBrick(createBrick(1029,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,214,-1,["Moon","Rock","Stone","Metal","Grey","Gray"]));
         _loc68_.addBrick(createBrick(601,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,101,-1,["White","Grey","Gray","Metal"]));
         _loc68_.addBrick(createBrick(602,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,102,-1,["Blue","Metal"]));
         _loc68_.addBrick(createBrick(603,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,103,-1,["Green","Metal"]));
         _loc68_.addBrick(createBrick(604,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,104,-1,["Red","Metal"]));
         _loc68_.addBrick(createBrick(332,ItemLayer.DECORATION,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,false,203,0,["Sign","Panel","Computer","Green"]));
         _loc68_.addBrick(createBrick(333,ItemLayer.DECORATION,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,false,204,0,["Red","Dot","Light","Lamp","Circle","Orb","Button"]));
         _loc68_.addBrick(createBrick(334,ItemLayer.DECORATION,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,false,205,0,["Blue","Dot","Light","Lamp","Circle","Orb","Button"]));
         _loc68_.addBrick(createBrick(1567,ItemLayer.DECORATION,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,false,352,0,["Green","Dot","Light","Lamp","Circle","Orb","Button"]));
         _loc68_.addBrick(createBrick(1568,ItemLayer.DECORATION,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,false,353,0,["Yellow","Dot","Light","Lamp","Circle","Orb","Button"]));
         _loc68_.addBrick(createBrick(1623,ItemLayer.DECORATION,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,false,366,0,["Magenta","Pink","Purple","Dot","Light","Lamp","Circle","Orb","Button"]));
         _loc68_.addBrick(createBrick(1624,ItemLayer.DECORATION,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,false,367,0,["Cyan","Dot","Light","Lamp","Circle","Orb","Button"]));
         _loc68_.addBrick(createBrick(335,ItemLayer.DECORATION,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,false,206,0,["Computer","Control panel","System"]));
         _loc68_.addBrick(createBrick(428,ItemLayer.DECORATION,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,false,270,0,["Star","Shiny","Red","Light","Night","Sky","Big"]));
         _loc68_.addBrick(createBrick(429,ItemLayer.DECORATION,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,false,271,0,["Star","Shiny","Blue","Light","Night","Sky","Medium"]));
         _loc68_.addBrick(createBrick(430,ItemLayer.DECORATION,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,false,272,0,["Star","Shiny","Yellow","Light","Night","Sky","Small"]));
         _loc68_.addBrick(createBrick(331,ItemLayer.ABOVE,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,false,202,0,["Rock","Hard","Gray","Grey","Boulder","Stone","Environment"]));
         brickPackages.push(_loc68_);
         var _loc69_:ItemBrickPackage = new ItemBrickPackage("desert","Desert Pack",["Environment"]);
         _loc69_.addBrick(createBrick(177,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,151,4292711483,["Mars","Orange","Sandstone","Ground","Soil","Dirt","Rocky","Space"]));
         _loc69_.addBrick(createBrick(178,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,152,4291200308,["Mars","Orange","Sandstone","Ground","Soil","Dirt","Rocky","Space"]));
         _loc69_.addBrick(createBrick(179,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,153,4287717671,["Mars","Orange","Sandstone","Ground","Soil","Dirt","Rocky","Space"]));
         _loc69_.addBrick(createBrick(180,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,154,-1,["Mars","Orange","Sandstone","Ground","Soil","Dirt","Rocky","Space"]));
         _loc69_.addBrick(createBrick(181,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,155,-1,["Mars","Orange","Sandstone","Ground","Soil","Dirt","Rocky","Space"]));
         _loc69_.addBrick(createBrick(336,ItemLayer.ABOVE,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,false,207,0,["Rock","Orange","Sandstone","Boulder","Space"]));
         _loc69_.addBrick(createBrick(425,ItemLayer.ABOVE,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,false,267,0,["Cactus","Nature","Plant","Western"]));
         _loc69_.addBrick(createBrick(426,ItemLayer.ABOVE,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,false,268,0,["Bush","Cactus","Nature","Plant","Western"]));
         _loc69_.addBrick(createBrick(427,ItemLayer.ABOVE,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,false,269,0,["Tree","Nature","Plant","Bush","Western","Bonsai"]));
         _loc69_.addBrick(createBrick(699,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,193,-1,["Brown","Dirt","Soil","Sandstone"]));
         _loc69_.addBrick(createBrick(700,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,194,-1,["Brown","Dirt","Soil","Sandstone"]));
         _loc69_.addBrick(createBrick(701,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,195,-1,["Brown","Dirt","Soil","Sandstone"]));
         ...
         _loc75_.addBrick(createBrick(193,ItemLayer.DECORATION,blocksBMD,"","",ItemTab.BLOCK,false,true,168,0,["Idol","Face","Brick","No show","Statue","Totem","Ruins"]));
         _loc75_.addBrick(createBrick(194,ItemLayer.DECORATION,blocksBMD,"","",ItemTab.BLOCK,false,true,169,0,["Platform","Old","Mossy","Ruins","Stone"]));
         _loc75_.addBrick(createBrick(195,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,170,4288256378,["Brick","Grey","Gray","Ruins","Stone"]));
         _loc75_.addBrick(createBrick(196,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,171,4289491041,["Brick","Red","Pink","Ruins","Stone"]));
         _loc75_.addBrick(createBrick(197,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,172,4284647578,["Brick","Blue","Ruins","Stone"]));
         _loc75_.addBrick(createBrick(198,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,173,4287071297,["Brick","Yellow","Olive","Ruins","Stone","Green"]));
         _loc75_.addBrick(createBrick(617,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,117,4284900945,["Brick","Grey","Gray","Ruins","Stone"]));
         _loc75_.addBrick(createBrick(618,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,118,4286008900,["Brick","Red","Pink","Ruins","Stone"]));
         _loc75_.addBrick(createBrick(619,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,119,4282473062,["Brick","Blue","Ruins","Stone"]));
         _loc75_.addBrick(createBrick(620,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,120,4285229108,["Brick","Yellow","Olive","Ruins","Stone","Green"]));
         _loc75_.addBrick(createBrick(199,ItemLayer.DECORATION,blocksBMD,"","",ItemTab.BLOCK,false,true,176,0,["Pot","Jar","Clay","Ruins","Urn"]));
         _loc75_.addBrick(createBrick(621,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,121,4285039619,["Leaves","Green","Grass","Environment","Nature"]));
         _loc75_.addBrick(createBrick(622,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,122,4283985923,["Leaves","Green","Grass","Environment","Nature"]));
         _loc75_.addBrick(createBrick(623,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,123,4282536962,["Leaves","Green","Grass","Environment","Nature"]));
         _loc75_.addBrick(createBrick(357,ItemLayer.ABOVE,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,false,227,0,["Bush","Plant","Nature","Environment"]));
         _loc75_.addBrick(createBrick(358,ItemLayer.ABOVE,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,false,228,0,["Rock","Pot","Jar","Basket","Ruins","Clay"]));
         _loc75_.addBrick(createBrick(359,ItemLayer.ABOVE,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,false,229,0,["Idol","Statue","Gold","Trophy","Artifact","Artefact","Yellow","Ruins"]));
         ...
         _loc81_.addBrick(createBrick(ItemId.TEXT_SIGN,ItemLayer.ABOVE,specialBlocksBMD,"bricksign","players will see a custom message when they touch this block",ItemTab.ACTION,false,true,513,0,["Morphable","Write","Text","Wood","Info"]));
         ...
         _loc88_.addBrick(createBrick(ItemId.EFFECT_JUMP,ItemLayer.DECORATION,effectBlocksBMD,"brickeffectjump","jump effect: players jump twice or half as high",ItemTab.ACTION,false,false,0,0,["Jump","Boost","High","Low"]));
         _loc88_.addBrick(createBrick(ItemId.EFFECT_FLY,ItemLayer.DECORATION,effectBlocksBMD,"brickeffectfly","fly effect: players can levitate by holding space",ItemTab.ACTION,false,false,1,0,["Fly","Hover","Levitate"]));
         _loc88_.addBrick(createBrick(ItemId.EFFECT_RUN,ItemLayer.DECORATION,effectBlocksBMD,"brickeffectspeed","speed effect: players move 50% faster or slower",ItemTab.ACTION,false,false,2,0,["Speed","Fast","Run","Slow"]));
         _loc88_.addBrick(createBrick(ItemId.EFFECT_LOW_GRAVITY,ItemLayer.DECORATION,effectBlocksBMD,"brickeffectlowgravity","low gravity effect: player gravity is reduced",ItemTab.ACTION,false,false,13,0,["Gravity","Moon","Low gravity","Space","Slow fall","Float"]));
         _loc88_.addBrick(createBrick(ItemId.EFFECT_PROTECTION,ItemLayer.DECORATION,effectBlocksBMD,"brickeffectprotection","protection effect: players are safe from hazards and cured from curses/zombies",ItemTab.ACTION,false,false,3,0,["Invincible","Health","Plus","Immortal","Protection"]));
         _loc88_.addBrick(createBrick(ItemId.EFFECT_CURSE,ItemLayer.DECORATION,effectBlocksBMD,"brickeffectcurse","players die after X seconds, spreads on contact, maximum of 3 curses at a time",ItemTab.ACTION,false,false,4,0,["Curse","Skull","Skeleton","Timed","Death","Die","Kill"]));
         _loc88_.addBrick(createBrick(ItemId.EFFECT_MULTIJUMP,ItemLayer.DECORATION,effectBlocksBMD,"brickeffectmultijump","multijump effect: players can jump X times",ItemTab.ACTION,false,false,15,0,["Double","Jump","Twice","Powers","Action","Physics"]));
         _loc88_.addBrick(createBrick(ItemId.EFFECT_GRAVITY,ItemLayer.DECORATION,specialBlocksBMD,"brickeffectgravity","gravity effect: player gravity is rotated",ItemTab.ACTION,false,false,657,0,["Gravity","Reverse","Action","Physics"]));
         _loc88_.addBrick(createBrick(ItemId.EFFECT_POISON,ItemLayer.DECORATION,effectBlocksBMD,"brickeffectpoison","poison effect: players die after X seconds, does not spread",ItemTab.ACTION,false,false,23,0,["Poison","Toxic","Action","Timed","Death","Die","Kill"]));
         _loc88_.addBrick(createBrick(ItemId.EFFECT_RESET,ItemLayer.DECORATION,effectBlocksBMD,"brickeffectreset","reset effect: resets all non-timed effects",ItemTab.ACTION,false,false,26,0,["Reset","Action","Physics"]));
         ...
         _loc92_.addBrick(createBrick(1030,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,215,-1,["Wood","Tree","Brown"]));
         _loc92_.addBrick(createBrick(1031,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,216,-1,["Leaves","Grass","Green","Plant"]));
         _loc92_.addBrick(createBrick(1032,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,217,-1,["Bamboo","Wood","Yellow"]));
         _loc92_.addBrick(createBrick(1033,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,218,-1,["Obsidian","Rock","Ice","Grey","Gray"]));
         _loc92_.addBrick(createBrick(1034,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,219,-1,["Fire","Lava","Hot"]));
         _loc92_.addBrick(createBrick(678,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,172,-1,["Wood","Tree","Brown"]));
         _loc92_.addBrick(createBrick(679,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,173,-1,["Leaves","Grass","Green"]));
         _loc92_.addBrick(createBrick(680,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,174,-1,["Bamboo","Wood"]));
         _loc92_.addBrick(createBrick(681,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,175,-1,["Obsidian","Rock","Ice","Grey","Gray"]));
         _loc92_.addBrick(createBrick(682,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,176,-1,["Fire","Lava","Hot","Molten"]));
         ...
         _loc95_.addBrick(createBrick(1059,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,237,-1,["Ice"]));
         _loc95_.addBrick(createBrick(1060,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,238,-1));
         _loc95_.addBrick(createBrick(1061,ItemLayer.DECORATION,blocksBMD,"","",ItemTab.BLOCK,false,true,239,-1,["Left"]));
         _loc95_.addBrick(createBrick(1062,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,240,-1,["Middle"]));
         _loc95_.addBrick(createBrick(1063,ItemLayer.DECORATION,blocksBMD,"","",ItemTab.BLOCK,false,true,241,-1,["Right"]));
         _loc95_.addBrick(createBrick(702,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,196,-1));
         _loc95_.addBrick(createBrick(703,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,false,197,-1));
         ...
         _loc105_.addBrick(createBrick(1096,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,265,-1,["Plywood","Wood","Brown","Tan"]));
         _loc105_.addBrick(createBrick(1097,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,266,-1,["Gravel","Stone","Gray","Grey"]));
         _loc105_.addBrick(createBrick(1098,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,267,-1,["Cement","Stone","Beige"]));
         _loc105_.addBrick(createBrick(1099,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,268,-1,["Beam","Metal","Red","Horizontal"]));
         _loc105_.addBrick(createBrick(1130,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,291,-1,["Beam","Metal","Red","Horizontal"]));
         _loc105_.addBrick(createBrick(1128,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,289,-1,["Beam","Metal","Red","Horizontal"]));
         _loc105_.addBrick(createBrick(1129,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,290,-1,["Beam","Metal","Red","Vertical"]));
         _loc105_.addBrick(createBrick(1131,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,292,-1,["Beam","Metal","Red","Vertical"]));
         _loc105_.addBrick(createBrick(1100,ItemLayer.FORGROUND,blocksBMD,"","",ItemTab.BLOCK,false,true,269,-1,["Beam","Metal","Red","Vertical"]));
         _loc105_.addBrick(createBrick(1503,ItemLayer.DECORATION,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,true,310,0,["Sawhorse","Orange","White","Caution","Sign","Stripes","Horizontal"]));
         _loc105_.addBrick(createBrick(1504,ItemLayer.DECORATION,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,true,311,0,["Cone","Orange","White"]));
         _loc105_.addBrick(createBrick(1505,ItemLayer.DECORATION,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,true,312,0,["Sign","Orange","Caution","Warning"]));
         _loc105_.addBrick(createBrick(1532,ItemLayer.DECORATION,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,true,333,0,["Sign","Red","Caution","Warning","Stop"]));
         _loc105_.addBrick(createBrick(1533,ItemLayer.DECORATION,decoBlocksBMD,"","",ItemTab.DECORATIVE,false,true,334,0,["Red","Fire","Hydrant"]));
         _loc105_.addBrick(createBrick(728,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,222,-1,["Plywood","Wood","Brown","Tan"]));
         _loc105_.addBrick(createBrick(729,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,223,-1,["Gravel","Stone","Gray","Grey"]));
         _loc105_.addBrick(createBrick(730,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,224,-1,["Cement","Stone","Beige"]));
         _loc105_.addBrick(createBrick(731,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,225,-1,["Beam","Metal","Red","Horizontal"]));
         _loc105_.addBrick(createBrick(755,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,249,-1,["Beam","Metal","Red","Horizontal"]));
         _loc105_.addBrick(createBrick(753,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,247,-1,["Beam","Metal","Red","Horizontal"]));
         _loc105_.addBrick(createBrick(754,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,248,-1,["Beam","Metal","Red","Vertical"]));
         _loc105_.addBrick(createBrick(756,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,250,-1,["Beam","Metal","Red","Vertical"]));
         _loc105_.addBrick(createBrick(732,ItemLayer.BACKGROUND,bgBlocksBMD,"","",ItemTab.BACKGROUND,false,true,226,-1,["Beam","Metal","Red","Vertical"]));
         ...
         _loc114_.addBrick(createBrick(ItemId.GOLDEN_EASTER_EGG,ItemLayer.ABOVE,decoBlocksBMD,"brickspecial","",ItemTab.DECORATIVE,true,false,358,-1));
         _loc114_.addBrick(createBrick(ItemId.GREEN_SPACE,ItemLayer.DECORATION,decoBlocksBMD,"brickspecial","",ItemTab.DECORATIVE,false,true,363,-1));
         _loc114_.addBrick(createBrick(ItemId.GOLD_SACK,ItemLayer.DECORATION,decoBlocksBMD,"brickspecial","",ItemTab.DECORATIVE,false,true,364,-1));
         ...
         _loc117_.addBrick(createBrick(ItemId.SHADOW_A,ItemLayer.DECORATION,shadowBlocksBMD,"","",ItemTab.DECORATIVE,false,false,1,0,["Morphable"],false,false,_loc116_));
         _loc117_.addBrick(createBrick(ItemId.SHADOW_B,ItemLayer.DECORATION,shadowBlocksBMD,"","",ItemTab.DECORATIVE,false,false,5,0,["Morphable"],false,false,_loc116_));
         _loc117_.addBrick(createBrick(ItemId.SHADOW_C,ItemLayer.DECORATION,shadowBlocksBMD,"","",ItemTab.DECORATIVE,false,false,9,0,["Morphable"],false,false,_loc116_));
         _loc117_.addBrick(createBrick(ItemId.SHADOW_D,ItemLayer.DECORATION,shadowBlocksBMD,"","",ItemTab.DECORATIVE,false,false,11,0,["Morphable"],false,false,_loc116_));
         _loc117_.addBrick(createBrick(ItemId.SHADOW_E,ItemLayer.DECORATION,shadowBlocksBMD,"","",ItemTab.DECORATIVE,false,false,14,0,[],false,false,_loc116_));
         _loc117_.addBrick(createBrick(ItemId.SHADOW_F,ItemLayer.DECORATION,shadowBlocksBMD,"","",ItemTab.DECORATIVE,false,false,16,0,["Morphable"],false,false,_loc116_));
         _loc117_.addBrick(createBrick(ItemId.SHADOW_G,ItemLayer.DECORATION,shadowBlocksBMD,"","",ItemTab.DECORATIVE,false,false,20,0,["Morphable"],false,false,_loc116_));
         _loc117_.addBrick(createBrick(ItemId.SHADOW_H,ItemLayer.DECORATION,shadowBlocksBMD,"","",ItemTab.DECORATIVE,false,false,24,0,["Morphable"],false,false,_loc116_));
         _loc117_.addBrick(createBrick(ItemId.SHADOW_I,ItemLayer.DECORATION,shadowBlocksBMD,"","",ItemTab.DECORATIVE,false,false,26,0,["Morphable"],false,false,_loc116_));
         _loc117_.addBrick(createBrick(ItemId.SHADOW_J,ItemLayer.DECORATION,shadowBlocksBMD,"","",ItemTab.DECORATIVE,false,false,29,0,[],false,false,_loc116_));
         _loc117_.addBrick(createBrick(ItemId.SHADOW_K,ItemLayer.DECORATION,shadowBlocksBMD,"","",ItemTab.DECORATIVE,false,false,31,0,["Morphable"],false,false,_loc116_));
         _loc117_.addBrick(createBrick(ItemId.SHADOW_L,ItemLayer.DECORATION,shadowBlocksBMD,"","",ItemTab.DECORATIVE,false,false,35,0,["Morphable"],false,false,_loc116_));
         _loc117_.addBrick(createBrick(ItemId.SHADOW_M,ItemLayer.DECORATION,shadowBlocksBMD,"","",ItemTab.DECORATIVE,false,false,39,0,["Morphable"],false,false,_loc116_));
         _loc117_.addBrick(createBrick(ItemId.SHADOW_N,ItemLayer.DECORATION,shadowBlocksBMD,"","",ItemTab.DECORATIVE,false,false,43,0,["Morphable"],false,false,_loc116_));
