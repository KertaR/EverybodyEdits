package
{
   ...
   public class TextBubble
   {
      ...
      private var colors:Array = [16777215,6724095,16732240,16765210];
      ...
      public function update(param1:String, param2:int = 0, param3:Boolean = true, param4:uint = 0) : void
      {
         ...
         param1 = param1.replace(/%Username%/g,_loc5_.name.substring(0,1).toUpperCase() + _loc5_.name.substr(1));
